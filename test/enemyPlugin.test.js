...
import enemyPlugin, { ENEMY_ARCHETYPES } from '../src/plugins/enemy-plugin/index.js';
...
test('each archetype is registered with the stats and marker component from ENEMY_ARCHETYPES', () => {
  const api = buildApi();
